                      ...
                      return (
                        <div className="border w-3/4 overflow-y-auto">
                          ...
                          <div className="flex justify-center items-center h-full w-full p-5">
                            <div className="relative border w-full border-gray-500 h-2/4 rounded-md mt-[3rem]">
                              ...
                              <form action="">
                                <div className="w-full grid grid-cols-2 p-5 gap-2">
                                  ...
                                  <div className="col-span-1">
                                    ...
                                    <input
                                      type="file"
                                      className="cursor-pointer w-full px-2 py-2 bg-transparent border border-gray-400 focus:outline-none text-white rounded-md text-sm"
                                    />
                                  </div>
                                  <div className="col-span-1">
                                    <button
